...
create table  centro  (
	cenNumero  int(11) not null default '0',
	cenNome  char(30) default null,
	cenEnderezo  char(30) default null,
	primary key (cenNumero),
	constraint uk_cenNumero unique key cenNumero (cenNumero)
) engine=myisam ;
insert into centro  
...
-- Contén información dos departamentos da empresa
 create table  departamento  (
	depNumero  int(11) not null default '0',
	depNome  char(20) default null,   
	depDirector  int(11) not null default '0',
...
create table  empregado  (
	empNumero  int(11) not null default '0',
	empDepartamento  int(11) not null default '0' comment 'número de departamento no que traballa o empregado',
	empExtension smallint(6) not null default '0' comment 'extensión telefónica para o traballador',
