...
public class InvoiceController {
    ...
    public ResponseEntity<List<InvoiceDTO>> getInvoicesByUserId(@PathVariable Long userId) {
        List<InvoiceDTO> invoices = invoiceService.getInvoicesByUserId(userId).stream()
                .map(invoice -> modelMapper.map(invoice, InvoiceDTO.class))
                .collect(Collectors.toList());
        return ResponseEntity.ok(invoices);
    }
    ...
    public ResponseEntity<InvoiceDTO> generateInvoiceFromExchange(@PathVariable Long exchangeId) {
    ...
    public ResponseEntity<InvoiceDTO> generateInvoiceFromSale(
